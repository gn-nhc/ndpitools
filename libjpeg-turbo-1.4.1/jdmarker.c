...
/* Process a SOFn marker */
{
  ...
  if (cinfo->image_height) {
    unsigned int height;
    INPUT_2BYTES(cinfo, height, return FALSE);
    /*fprintf(stderr, "INFO: Image height found in the JPEG stream (%u) is overriden by %lu.\n",
  ...
  if (cinfo->image_width) {
    ...
    /*fprintf(stderr, "INFO: Image width found in the JPEG stream (%u) is overriden by %lu.\n",
