...
#define FIELD_SETLONGS 4
	...
	float	td_ndpimagnification;
	int32_t	td_ndpizoffset;
	char*	td_ndpiusergivenslidelabel;
	uint32_t	td_ndpinblanklanes;
	uint32_t*	td_ndpiblanklanes;
	char*	td_ndpicomments;
	char*	td_ndpifluorescence;
...
#define FIELD_NDPIMAGNIFICATION        50
#define FIELD_NDPIZOFFSET              51
#define FIELD_NDPIUSERGIVENSLIDELABEL  52
#define FIELD_NDPIBLANKLANES           53
#define FIELD_NDPICOMMENTS             54
#define FIELD_NDPIFLUORESCENCE         55
